...
class EXVisualLiDARCalibration {
public:
  EXVisualLiDARCalibration(const std::string& data_path, const boost::program_options::variables_map& vm) : data_path(data_path) {
  ...
  void extrinsic_calibrate(const boost::program_options::variables_map& vm) {
    ...
    EXVisualCameraCalibrationParams params;
    ...
    std::thread optimization_thread([&] {
      T_camera_lidar = ex_calib.extrinsic_calibrate(init_T_camera_lidar);
...
int main(int argc, char** argv) {
  ...
  vlcal::EXVisualLiDARCalibration ex_calib(data_path, vm);
  ex_calib.extrinsic_calibrate(vm);
